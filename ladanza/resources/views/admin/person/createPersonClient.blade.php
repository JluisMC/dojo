    ...
    <div class="page_user_show">
        <div class="row">
                        ...
                        <div class="row">
                            <form action="{{route('person.store')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="submit" value="Completado" class="btn btn-success mt-2">
                                </div>
                            </form>
            ...
            <div class="col-md-4 d-flex">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-plus"></i>  Referencias</h2>
                    </div>
                    <div class="inside">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="label_ini">Referencia 1:</label>
                                <div class="input-group">
                                    <div class="input-group-text"><i class="fas fa-keyboard"></i></div>
